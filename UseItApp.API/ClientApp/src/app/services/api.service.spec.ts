...
describe('ApiService', () => {
  ...
  describe('Item operations', () => {
    it('should get all items', () => {
      ...
      const req = httpTestingController.expectOne('192.168.34.132:7001/api/items');
    ...
    it('should get item by id', () => {
      ...
      const req = httpTestingController.expectOne('192.168.34.132:7001/api/items/1');
      expect(req.request.method).toEqual('GET');
      req.flush(mockItem);
    });
    ...
    it('should get user items', () => {
      ...
      const req = httpTestingController.expectOne('192.168.34.132:7001/api/items/user');
      expect(req.request.method).toEqual('GET');
      req.flush(mockItems);
    });
  });
  ...
  describe('Loan operations', () => {
    it('should get all loans', () => {
      ...
      const req = httpTestingController.expectOne('192.168.34.132:7001/api/loans');
      expect(req.request.method).toEqual('GET');
      req.flush(mockLoans);
    });
    ...
    it('should get user loans', () => {
      ...
      const req = httpTestingController.expectOne('192.168.34.132:7001/api/loans/user');
      expect(req.request.method).toEqual('GET');
      req.flush(mockLoans);
    });
    ...
    it('should get loans for owner', () => {
      ...
      const req = httpTestingController.expectOne('192.168.34.132:7001/api/loans/owner');
      expect(req.request.method).toEqual('GET');
      req.flush(mockLoans);
    });
    ...
    it('should update loan status', () => {
      ...
      const req = httpTestingController.expectOne('192.168.34.132:7001/api/loans/1/status');
      expect(req.request.method).toEqual('PUT');
    ...
    it('should initiate return', () => {
      ...
      const req = httpTestingController.expectOne('192.168.34.132:7001/api/loans/1/initiate-return');
      expect(req.request.method).toEqual('PUT');
    ...
    it('should confirm return', () => {
      ...
      const req = httpTestingController.expectOne('192.168.34.132:7001/api/loans/1/confirm-return');
      expect(req.request.method).toEqual('PUT');
      expect(req.request.body).toEqual({});
      req.flush(null);
    });
    ...
    it('should approve loan request', () => {
      ...
      const req = httpTestingController.expectOne('192.168.34.132:7001/api/loans/1/approve');
      expect(req.request.method).toEqual('PUT');
      expect(req.request.body).toEqual({});
      req.flush(null);
    });
    ...
    it('should reject loan request', () => {
      ...
      const req = httpTestingController.expectOne('192.168.34.132:7001/api/loans/1/reject');
      expect(req.request.method).toEqual('PUT');
      expect(req.request.body).toEqual({});
      req.flush(null);
    });
    ...
    it('should activate loan', () => {
      ...
      const req = httpTestingController.expectOne('192.168.34.132:7001/api/loans/1/activate');
      expect(req.request.method).toEqual('PUT');
      expect(req.request.body).toEqual({});
      req.flush(null);
    });
