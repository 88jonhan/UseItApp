...
describe('AuthService', () => {
  ...
  it('should register new user', () => {
    ...
    const req = httpTestingController.expectOne('https://localhost:7001/api/auth/register');
  ...
  it('should login user with correct credentials', () => {
    ...
    const req = httpTestingController.expectOne('https://localhost:7001/api/auth/login');
    expect(req.request.method).toEqual('POST');
    expect(req.request.body).toEqual({
      username: 'testuser',
      password: 'password123'
